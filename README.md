...
This is the frontend for our database final project TickIt. It is a static HTML, CSS, and vanilla JS site that calls the backend API at `http://127.0.0.1:3000` for authentication, ticket purchasing, weather logging, exports, and organizer workflows.
...
- `libs/chart.min.js`
   ...
   ```
- `images/` - Images used on the user/guest dashboards for display
